                ...
                @enderror
                    ...
                    <div class="card">
                        <div class="card-header border-bottom-0">
                            ...
                            <a class="btn btn-primary badge" data-target="#user-form-modal" data-bs-toggle="" href="{{ route('admin.users.admin-users.create') }}">ایجاد کاربر جدید</a>
                                ...
                                <table class="table border-top table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">{{ $admin->full_name }}</td>
                                            <td class="text-nowrap align-middle">{{ $admin->user_name }}</td>
                                            <td class="text-nowrap align-middle">{{ $admin->mobile }}</td>
                                            <td class="text-nowrap align-middle"><span>{{ jalaliDate($admin->created_at) }}</span></td>
                                            <td class="text-center align-middle">
                                                <div class="btn-group align-top">
                                                    <a class="btn btn-sm text-primary" data-target="#user-form-modal"  data-target="#user-form-modal" data-bs-toggle="tooltip" title data-bs-original-title="ویرایش" href="{{ route('admin.users.admin-users.edit', $admin->id) }}"><span class="fe fe-edit fs-14"></span></a>
                                                    @if (auth()->user()->id != $admin->id)
                                                    <form action="{{ route('admin.users.admin-users.destroy', $admin->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
