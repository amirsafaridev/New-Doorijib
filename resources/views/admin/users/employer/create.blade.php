...
@section('head-tag')
<title>ایجاد کاربر کارفرما</title>
@endsection
@section('content')
        <!-- CONTAINER -->
            ...
            <div class="page-header">
                ...
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.users.employer-users.index') }}">کاربران کارفرما</a></li>
                        <li class="breadcrumb-item active" aria-current="page">ایجاد کاربر کارفرما</li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
                ...
                <div class="col-md-12 col-xl-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ایجاد کاربر کارفرما</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.users.employer-users.store') }}" method="POST">
                                @csrf
                                <div class="row">
