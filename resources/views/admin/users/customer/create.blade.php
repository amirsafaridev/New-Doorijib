            ...
            <div class="page-header">
                ...
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('admin.users.admin-users.index') }}">کاربران مشتری</a></li>
                ...
                <div class="col-md-12 col-xl-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ایجاد کاربر مشتری</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.users.customer-users.store') }}" method="POST">
                                @csrf
                                <div class="row">
