        ...
        <div class="row">
            <div class="col-md-12 col-xl-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.advertise-category.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    <label for="name" class="form-label">نام دسته</label>
                                    <input type="text" name="name" class="form-control" id="name"
                                        value="{{ old('name') }}" placeholder="نام دسته ">
                                    @error('name')
                                ...
                                <div class="form-group col-12 mt-2">
                                    ...
                                    <textarea name="content" id="summernote" class="form-control form-control-sm"rows="10">{{ old('content') }}</textarea>
                                    @error('content')
                                        <span class="text-danger rounded p-1" role="alert">
                                            <strong>
                                                {{ $message }}
