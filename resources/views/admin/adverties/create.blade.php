        ...
        <div class="page-header">
            ...
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ایجاد آگهی جدید</li>
                </ol>
            </div>
        </div>
        <!-- PAGE-HEADER END -->
        ...
        <div class="row">
            <div class="col-md-12 col-xl-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.advertise.store') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" name="work_houres" class="form-control" id="work_houres"
                                        value="{{ old('work_houres') }}" placeholder="ساعت کاری" />
                                    @error('work_houres')
                                        <span class="rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" name="benefites" class="form-control" id="benefites"
                                        value="{{ old('benefites') }}" placeholder="مزایا" />
                                    @error('benefites')
                                        <span class="rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" name="salary_range" class="form-control" id="salary_range"
                                        value="{{ old('salary_range') }}" placeholder="حقوق" />
                                    @error('salary_range')
                                        <span class="rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
                                ...
                                <div class="form-group col-md-6 col-12 mt-2">
                                    ...
                                    @error('contact_type')
                                        <span class="text-danger rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
                                            </strong>
                                        </span>
                                ...
                                <div class="form-group col-md-6 col-12" style="display: none" id="telegram-section">
                                    <label for="telegram" class="form-label">تلگرام</label>
                                    <input type="text" name="telegram" class="form-control" id="telegram"
                                        value="{{ old('telegram') }}" placeholder="تلگرام" disabled />
                                    @error('telegram')
                                        <span class="rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
                                ...
                                <div class="form-group col-md-6 col-12" style="display: none" id="whatsapp-section">
                                    <label for="whatsapp" class="form-label">واتساپ</label>
                                    <input type="text" name="whatsapp" class="form-control" id="whatsapp"
                                        value="{{ old('whatsapp') }}" placeholder="واتساپ" disabled />
                                    @error('whatsapp')
                                        <span class="rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
                                ...
                                <div class="form-group col-md-6 col-12 mt-2">
                                    ...
                                    <select name="contract_type" id="contract_type" class="form-control">
                                        <option value="" selected>لطفا نوع قرارداد را انتخاب کنید
                                        </option>
                                ...
                                <div class="form-group col-md-6 col-12 mt-2">
                                    ...
                                    @enderror
                                    <div class="holder mt-3 d-none" id="image-preview-container">
                                ...
                                <div class="form-group col-12 mt-2">
                                    ...
                                    <textarea placeholder="توضیحات" name="content" id="summernote" class="form-control form-control-sm"rows="10">{{ old('content') }}</textarea>
                                    @error('content')
                                        <span class="text-danger rounded p-1" role="alert">
                                            <strong>
                                                {{ $message }}
