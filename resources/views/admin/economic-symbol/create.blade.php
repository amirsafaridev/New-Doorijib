...
@section('head-tag')
    <title>ایجاد نماد اقتصادی جدید</title>
@endsection
@section('content')
    <!-- CONTAINER -->
        ...
        <div class="page-header">
            ...
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ایجاد نماد اقتصادی جدید</li>
                </ol>
            </div>
        </div>
        <!-- PAGE-HEADER END -->
            ...
            <div class="col-md-12 col-xl-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ایجاد نماد اقتصادی جدید</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.economic-symbol.store') }}" enctype="multipart/form-data"
                            method="POST">
                            @csrf
                            <div class="row">
