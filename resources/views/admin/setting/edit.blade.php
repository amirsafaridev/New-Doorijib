        ...
        <div class="page-header">
            ...
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ویرایش تنظیمات سایت</li>
                </ol>
            </div>
        </div>
        <!-- PAGE-HEADER END -->
            ...
            <div class="col-md-12 col-xl-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ویرایش تنظیمات سایت</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.setting.update', $setting->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    value="{{ old('telegram', $setting->value['telegram']) }}"   placeholder="تلگرام" />
                                    @error('telegram')
                                ...
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    value="{{ old('instagram', $setting->value['instagram']) }}"   placeholder="اینستاکرام" />
                                    @error('telegram')
                                        <span class="rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
                                ...
                                <div class="form-group col-md-4 col-12">
                                    ...
                                    value="{{ old('linkedin', $setting->value['linkedin']) }}"   placeholder="لینکدین" />
                                    @error('linkedin')
                                        <span class="rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
                                    ...
                                    <select name="category_id_1" id="category_id_1" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if (old('category_id_1', $setting->value['category_id_1']) == $category->id) selected @endif>
                                                {{ $category->value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-4 col-12 mt-2">
                                    ...
                                    <select name="category_id_2" id="category_id_2" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if (old('category_id_2', $setting->value['category_id_2']) == $category->id) selected @endif>
                                                {{ $category->value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-4 col-12 mt-2">
                                    ...
                                    <select name="category_id_3" id="category_id" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if (old('category_id_3', $setting->value['category_id_3']) == $category->id) selected @endif>
                                                {{ $category->value }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-12 mt-2">
                                    ...
                                    <textarea name="description" id="summernote" class="form-control form-control-sm"rows="10">{{ old('description', $setting->value['description']) }}</textarea>
                                    @error('description')
