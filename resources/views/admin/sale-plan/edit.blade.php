            ...
            <div class="page-header">
                ...
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ویرایش پلن‌ اشتراک </li>
                    </ol>
                </div>
            </div>
            <!-- PAGE-HEADER END -->
                ...
                <div class="col-md-12 col-xl-12 col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">ویرایش پلن‌ اشتراک</h4>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.sales-plan.update', $salePlan->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="form-group col-md-6 col-12">
                                        ...
                                        value="{{ old('title', $salePlan->title) }}"   placeholder="عنوان" />
                                        @error('title')
                                        ...
                                        <div class="form-group col-md-6 col-12">
                                            ...
                                            value="{{ old('price', $salePlan->price) }}"   placeholder="قیمت" />
                                            @error('price')
                                            <span class="rounded p-1 text-danger" role="alert">
                                                <strong>
                                                    {{ $message }}
                                    ...
                                    <div class="form-group col-12 mt-2">
                                        ...
                                        <textarea placeholder="توضیحات" name="description" id="summernote" class="form-control form-control-sm"rows="10">{{ old('description', $salePlan->description) }}</textarea>
                                        @error('description')
