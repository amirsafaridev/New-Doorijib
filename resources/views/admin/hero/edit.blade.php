        ...
        <div class="page-header">
            ...
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">وبرایش بنر اصلی</li>
                </ol>
            </div>
        </div>
        <!-- PAGE-HEADER END -->
            ...
            <div class="col-md-12 col-xl-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">وبرایش بتر اصلی</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.hero.update', $hero->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="title" id="summernote" class="form-control form-control-sm"rows="10">{{ old('title', $hero->value['title']) }}</textarea>
                                    @error('title')
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" name="subtitle" class="form-control" id="subtitle"
                                        value="{{ old('subtitle', $hero->value['subtitle']) }}" placeholder="زیر عنوان">
                                    @error('subtitle')
                                ...
                                <div class="form-group col-12 mt-2">
                                    ...
                                    <textarea name="description" id="summernote2" class="form-control form-control-sm"rows="10">{{ old('description', $hero->value['description']) }}</textarea>
                                    @error('description')
                                        <span class="text-danger rounded p-1" role="alert">
                                            <strong>
                                                {{ $message }}
