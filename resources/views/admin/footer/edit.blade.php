        ...
        <div class="page-header">
            ...
            <div>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ویرایش تنظیمات فوتر</li>
                </ol>
            </div>
        </div>
        <!-- PAGE-HEADER END -->
            ...
            <div class="col-md-12 col-xl-12 col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">ویرایش تنظیمات فوتر</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title"
                                        value="{{ old('title', $footer->value['title']) }}" placeholder="عنوان" />
                                    @error('title')
                                ...
                                <div class="form-group col-md-6 col-12">
                                    ...
                                    <input type="text" name="link" class="form-control" id="link"
                                        value="{{ old('link', $footer->value['link']) }}" placeholder="لینک" />
                                    @error('link')
                                        <span class="rounded p-1 text-danger" role="alert">
                                            <strong>
                                                {{ $message }}
