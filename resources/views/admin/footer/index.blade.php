...
@section('content')
    ...
    <div class="main-container container-fluid">
        ...
        <div class="page-header">
            <h1 class="page-title">فهرست تنظیمات فوتر</h1>
            <div>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">برنامه‌ها</a></li>
                    <li class="breadcrumb-item active" aria-current="page">فهرست تنظیمات فوتر</li>
                </ol>
            </div>
        </div>
        <!-- PAGE-HEADER END -->
                ...
                <div class="card">
                    <div class="card-header border-bottom-0">
                        ...
                        <a class="btn btn-primary badge" data-target="#category-form-modal" data-bs-toggle=""
                            href="{{ route('admin.footer.create') }}">ایجاد تنظیمات جدید</a>
                                ...
                                <tbody>
                                    @foreach ($footers as $footer)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">{{ $footer->value['title'] }}</td>
                                            <td class="align-middle text-center">{{ $footer->value['link'] }}</td>
                                            <td class="text-center align-middle">
                                                <div class="btn-group align-top">
                                                    <a class="btn btn-sm text-primary" data-target="#category-form-modal"
                                                        ...
                                                        href="{{ route('admin.footer.edit', $footer->id) }}"><span
                                                            class="fe fe-edit fs-14"></span></a>
                                                    <form action="{{ route('admin.footer.destroy', $footer->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
