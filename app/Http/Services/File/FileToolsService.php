...
class FileToolsService
{
    ...
    protected function provider()
    {
        ...
        //set a final file directory
        $finalDirectory = empty($this->getExclusiveDirectory()) ? $this->getFileDirectory() : $this->getExclusiveDirectory() . DIRECTORY_SEPARATOR . $this->getFileDirectory();
        $this->setFinalFileDirectory($finalDirectory);

        //set a final file name

        $this->setFinalFileName($this->getFileName() . '.' . $this->getFileFormat());


        // check an final file directory
