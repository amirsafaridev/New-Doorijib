...
return [
    ...
    */
    'attributes' => [
        ...
        "receiver"                  => "گیرنده",
        "deliver_id"                => "نحوه ارسال",
        "address_id"                => "آدرس",
        "copan"                     => "کد تخفیف",
        "payment_type"              => "نوع پرداخت",
        "delivery_id"               => "نوع ارسال",
        "permission"               => "دسترسی",
        "permissions"               => "سطوح دسترسی",
        "price_for_cooperation" => "قیمت برای همکار",
        "search"               => "جستجو",
        "user_name"               => "نام کاربری",
        "benefites"               => "نام کاربری",
        "salary_range"               => "حقوق",
        "work_houres"               => "ساعت کاری",
        "contact_type"               => "نحوه تماس",
        ...
        "telephone_number"               => "شماره تماس  شرکت",
        "site_name"               => "نام سایت",
        "subject"               => "موضوع",
        "role"               => "نوع گاربر",
        "rule"               => "تایید قوانین",
